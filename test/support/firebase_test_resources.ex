...
defmodule AshAuthentication.Strategy.FirebaseTest.SuccessSecret do
  @moduledoc false
  use AshAuthentication.Secret

  @impl true
  def secret_for(_path, _resource, _opts, _context), do: {:ok, "test-project"}
end

defmodule AshAuthentication.Strategy.FirebaseTest.ModuleSecretUser do
  @moduledoc false
  use Ash.Resource,
    domain: AshAuthentication.Strategy.FirebaseTest.TestDomain,
    data_layer: Ash.DataLayer.Ets,
  ...
  authentication do
    strategies do
      firebase do
        project_id(AshAuthentication.Strategy.FirebaseTest.SuccessSecret)
        token_input(:firebase_token)
      end
    end
  end
...
defmodule AshAuthentication.Strategy.FirebaseTest.FunctionSecretUser do
  @moduledoc false
  use Ash.Resource,
    domain: AshAuthentication.Strategy.FirebaseTest.TestDomain,
    data_layer: Ash.DataLayer.Ets,
  ...
  authentication do
    strategies do
      firebase do
        project_id(fn _path, _resource -> {:ok, "test-project"} end)
        token_input(:firebase_token)
      end
    end
  end
